package org.kg.myapp.file.model.vo;
...
public class FileVO {
	...
	public String toString() {
		return "FileVO [fileId=" + fileId + ", directoryName=" + directoryName + ", fileName=" + fileName
				+ ", fileSize=" + fileSize + ", fileContentType=" + fileContentType + ", fileUploadDate="
				+ fileUploadDate + ", fileData=" + Arrays.toString(fileData) + "]";
	}
